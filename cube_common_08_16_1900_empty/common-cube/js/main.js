...
const createScene = function () {
    ...
    babylonLoader = BABYLON.SceneLoader.Append("./assets/", "normal-cube.glb", scene, function (meshes) {
        ...
        scene.meshes.forEach(element => {
            if (element.name == 'image cube_primitive0' || element.name == 'image cube_primitive1' || element.name == 'image cube_primitive2' || element.name == 'image cube_primitive3') {
        ...
        // let backImg = new BABYLON.Texture("./assets/back-img.jpg", scene);
